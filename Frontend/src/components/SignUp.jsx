...
const SignUp = () => {
    ...
    const handleSignup = async (event) => {
        ...
        try {
            ...
            navigate(from, { replace: true }); // Navigate to the previous route after sign-up
        } catch (error) {
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7" onSubmit={handleSignup}>
                                ...
                                <p>If you have an account. Please <Link to="/login" className="text-green-700 underline">Login</Link> here</p>
                                <div className="relative">
                                    <button type="submit" className="bg-green-500 text-white rounded-md px-2 py-1">Sign Up</button>
                                </div>
